...
| Carpeta | Feature |
|---------|---------|
| `docs/feat-custom-user-tags/` | Etiquetas personalizadas (#5) |
| `docs/feat-menu-favoritos/` | Menu lateral - Favoritos (#7) |
| `docs/feat-menu-comentarios/` | Menu lateral - Comentarios (#9) |
| `docs/feat-menu-feedback-ratings-version/` | Feedback, Ratings, Version (#11) |
| `docs/fix-csp-and-tags-permissions/` | Fix CSP y permisos tags (#19) |
| `docs/feat-security-hardening/` | Security hardening (Cloud Functions, admin, rate limiting) |
| `docs/feat-firebase-quota-offline/` | Firebase quota mitigations (#24) |
| `docs/feat-modularizar-stats/` | Modularizar estadisticas (#28) |
