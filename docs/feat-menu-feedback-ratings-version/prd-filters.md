...
5. Botón/selector compacto para elegir criterio de orden.

### Modularización
6. Componente reutilizable `ListFilters` que recibe configuración de qué filtros mostrar.
7. Hook `useListFilters` que encapsula la lógica de filtrado y ordenamiento.
8. Las listas (FavoritesList, RatingsList) consumen el hook y pasan los datos filtrados.
