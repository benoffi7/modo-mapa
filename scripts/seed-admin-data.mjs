...
async function seed() {
  ...
  await setDoc(doc(db, 'config', 'perfCounters'), {
    ...
    cleanupRejectedPhotos: [1800, 2400, 3100, 4800, 2200],
    cleanupExpiredNotifications: [800, 1100, 1500, 2300, 1000],
    cleanupActivityFeed: [950, 1300, 1800, 2600, 1200],
    computeTrendingBusinesses: [6500, 8200, 10800, 14500, 7800],
    generateFeaturedLists: [4800, 6500, 8400, 11200, 6000],
    dailyMetrics: [3200, 4200, 5500, 7800, 3900],
    computeWeeklyRanking: [4100, 5400, 7200, 9100, 5000],
    computeMonthlyRanking: [5200, 6800, 9100, 12300, 6300],
    computeAlltimeRanking: [14500, 18500, 24000, 32000, 17200],
    // User-facing callables (Phase 4)
    cleanAnonymousData: [2400, 3200, 4500, 6400, 2900],
    deleteUserAccount: [3100, 4100, 5800, 8200, 3700],
    inviteListEditor: [220, 320, 480, 720, 280],
    removeListEditor: [180, 240, 380, 540, 220],
  });
  ...
  await setDoc(doc(db, 'dailyMetrics', todayStr), {
    performance: {
      ...
      queries: {
        ...
        ratings_countByUser: { p50: 80, p95: 200, count: 60 },
        ratings_hasUser: { p50: 50, p95: 110, count: 40 },
        ratings_upsertExists: { p50: 60, p95: 130, count: 30 },
        ratings_criteriaExists: { p50: 60, p95: 130, count: 18 },
        ratings_byBusinessIds: { p50: 220, p95: 480, count: 35 },
        ...
        follows_isFollowing: { p50: 55, p95: 130, count: 90 },
        follows_fetchFollowing: { p50: 130, p95: 320, count: 30 },
        users_search: { p50: 180, p95: 420, count: 25 },
        users_profileVisibility: { p50: 90, p95: 200, count: 60 },
        users_displayNames: { p50: 110, p95: 260, count: 40 },
        trending_fetchCurrent: { p50: 100, p95: 220, count: 50 },
        userSettings: { p50: 80, p95: 180, count: 200 },
        // S2 Medium reads (Phase 2)
        rankings_byPeriod: { p50: 140, p95: 320, count: 35 },
        rankings_latestByType: { p50: 170, p95: 380, count: 25 },
        rankings_userScoreHistory: { p50: 480, p95: 920, count: 18 },
        rankings_userLiveScore: { p50: 360, p95: 740, count: 22 },
        sharedLists_itemsForDelete: { p50: 90, p95: 220, count: 8 },
        sharedLists_itemsByList: { p50: 110, p95: 260, count: 50 },
        sharedLists_byId: { p50: 60, p95: 140, count: 80 },
        sharedLists_ownedByUser: { p50: 130, p95: 300, count: 45 },
        sharedLists_editorName: { p50: 70, p95: 170, count: 25 },
        sharedLists_sharedWithMe: { p50: 130, p95: 300, count: 30 },
        suggestions_favorites: { p50: 150, p95: 360, count: 28 },
        suggestions_ratings: { p50: 150, p95: 360, count: 28 },
        suggestions_userTags: { p50: 150, p95: 360, count: 28 },
        feedback_byUser: { p50: 110, p95: 250, count: 12 },
        priceLevels_all: { p50: 220, p95: 520, count: 8 },
        priceLevels_upsertExists: { p50: 55, p95: 130, count: 22 },
        specials_all: { p50: 70, p95: 160, count: 15 },
        specials_active: { p50: 70, p95: 160, count: 80 },
        specials_existingForSave: { p50: 85, p95: 200, count: 6 },
        achievements_all: { p50: 70, p95: 160, count: 30 },
        achievements_existingForSave: { p50: 85, p95: 200, count: 6 },
        metrics_dailyByDate: { p50: 65, p95: 150, count: 40 },
      ...
      functions: {
        ...
        // Scheduled (Phase 3)
        cleanupRejectedPhotos: { p50: 2400, p95: 4800, count: 7 },
        cleanupExpiredNotifications: { p50: 1100, p95: 2300, count: 7 },
        cleanupActivityFeed: { p50: 1300, p95: 2600, count: 7 },
        computeTrendingBusinesses: { p50: 8200, p95: 14500, count: 7 },
        generateFeaturedLists: { p50: 6500, p95: 11200, count: 1 },
        dailyMetrics: { p50: 4200, p95: 7800, count: 7 },
        computeWeeklyRanking: { p50: 5400, p95: 9100, count: 1 },
        computeMonthlyRanking: { p50: 6800, p95: 12300, count: 1 },
        computeAlltimeRanking: { p50: 18500, p95: 32000, count: 1 },
        // Callables (Phase 4)
        cleanAnonymousData: { p50: 3200, p95: 6400, count: 4 },
        deleteUserAccount: { p50: 4100, p95: 8200, count: 2 },
        inviteListEditor: { p50: 320, p95: 720, count: 12 },
        removeListEditor: { p50: 240, p95: 540, count: 8 },
      },
    },
  }, { merge: true });
