export const MSG_BUSINESS = {
  ratingSuccess: '¡Genial! También podés dejar un comentario.',
  ratingError: 'No se pudo guardar la calificación',
  ratingDeleteError: 'No se pudo borrar la calificación',
  ...
  emptyRatings: 'Sin calificaciones aún',
